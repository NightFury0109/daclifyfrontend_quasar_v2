        ...
        >
          ...
          <q-carousel-slide name="meta" class="">
            <div class="column q-gutter-md">
              <div>
                {{
                  `Transfer ${transfer_action.data.quantity} from ${transfer_action.data.from} to ${transfer_action.data.to}`
                }}
              </div>
              <q-input v-model="title" outlined type="text" placeholder="Title" />
              <q-input
                v-model="description"
                outlined
                type="textarea"
